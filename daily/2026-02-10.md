...
['a', 'b', 'c', 'd'].fill(0, 2) {|i| i.to_s } # => ["0", "1", "c", "d"]
['a', 'b', 'c', 'd'].fill(1, 2) {|i| i.to_s } # => ["a", "1", "2", "d"]
['a', 'b', 'c', 'd'].fill(2, 2) {|i| i.to_s } # => ["a", "b", "2", "3"]
...
['a', 'b', 'c', 'd'].fill(3, 2) {|i| i.to_s } # => ["a", "b", "c", "3", "4"]
['a', 'b', 'c', 'd'].fill(4, 2) {|i| i.to_s } # => ["a", "b", "c", "d", "4", "5"]
...
['a', 'b', 'c', 'd'].fill(5, 2) {|i| i.to_s } # => ["a", "b", "c", "d", nil, "5", "6"]
['a', 'b', 'c', 'd'].fill(6, 2) {|i| i.to_s } # => ["a", "b", "c", "d", nil, nil, "6", "7"]
...
['a', 'b', 'c', 'd'].fill(2, 0) {|i| fail 'Cannot happen' }    # => ["a", "b", "c", "d"]
['a', 'b', 'c', 'd'].fill(2, -100) {|i| fail 'Cannot happen' } # => ["a", "b", "c", "d"]
['a', 'b', 'c', 'd'].fill(6, -100) {|i| fail 'Cannot happen' } # => ["a", "b", "c", "d"]
...
['a', 'b', 'c', 'd'].fill(-4, 3) {|i| i.to_s } # => ["0", "1", "2", "d"]
['a', 'b', 'c', 'd'].fill(-3, 3) {|i| i.to_s } # => ["a", "1", "2", "3"]
...
['a', 'b', 'c', 'd'].fill(-2, 3) {|i| i.to_s } # => ["a", "b", "2", "3", "4"]
['a', 'b', 'c', 'd'].fill(-1, 3) {|i| i.to_s } # => ["a", "b", "c", "3", "4", "5"]
...
['a', 'b', 'c', 'd'].fill(-5, 2) {|i| i.to_s } # => ["0", "1", "c", "d"]
['a', 'b', 'c', 'd'].fill(-6, 2) {|i| i.to_s } # => ["0", "1", "c", "d"]
...
['a', 'b', 'c', 'd'].fill(-2, 0) {|i| fail 'Cannot happen' }  # => ["a", "b", "c", "d"]
['a', 'b', 'c', 'd'].fill(-2, -1) {|i| fail 'Cannot happen' } # => ["a", "b", "c", "d"]
...
['a', 'b', 'c', 'd'].fill('-', 2..1)          # => ["a", "b", "c", "d"]
['a', 'b', 'c', 'd'].fill(2..1) {|i| i.to_s } # => ["a", "b", "c", "d"]
...
['a', 'b', 'c', 'd'].fill(-3..2) {|i| i.to_s }  # => ["a", "1", "2", "d"]
['a', 'b', 'c', 'd'].fill(1..-2) {|i| i.to_s }  # => ["a", "1", "2", "d"]
['a', 'b', 'c', 'd'].fill(-3..-2) {|i| i.to_s } # => ["a", "1", "2", "d"]
